  ...
  execute: async (interaction) => {
    ...
    if (result) {
      await interaction.reply({
        content:
          "> <a:loading:1152363442414571560> **|** Aguarde, estamos encerrando seu timer...",
        ephemeral: true,
      });
    ...
    await interaction.reply({
      content:
        "> <a:loading:1152363442414571560> **|** Aguarde enquanto iniciamos seu timer...",
      ephemeral: true,
    });
    ...
    await interaction.editReply({
      content:
        "Você iniciou um timer, clique no botão abaixo para finalizá-lo.",
      components: [row],
    });
  },
};
